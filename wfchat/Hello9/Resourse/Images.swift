...
enum Images {
    ...
    static let icon_background_gray1 = UIImage(named: "icon_background_gray1")!
    ...
    static let icon_mine_setting = UIImage(named: "icon_mine_setting")!

    static let icon_mine_verify = UIImage(named: "icon_mine_verify")!

    static let icon_more = UIImage(named: "icon_more")!

    static let icon_more_dot = UIImage(named: "icon_more_dot")!

    static let icon_mute = UIImage(named: "icon_mute")!

    static let icon_mute_black = UIImage(named: "icon_mute_black")!
    ...
    static let icon_uncollected = UIImage(named: "icon_uncollected")!
